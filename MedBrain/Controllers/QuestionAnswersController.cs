...
namespace MedBrain.Controllers
{
    public class QuestionAnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "QuestionAnswerId,CorrectAnswer")] QuestionAnswer questionAnswer)
        {
            ...
            ViewBag.QuestionAnswerId = new SelectList(db.Questions, "QuestionId", "QuestionText", questionAnswer.QuestionAnswerId);
            return View(questionAnswer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "QuestionAnswerId,CorrectAnswer")] QuestionAnswer questionAnswer)
        {
            if (ModelState.IsValid)
            {
